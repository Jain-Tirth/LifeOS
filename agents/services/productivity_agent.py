...
productivity_agent = Agent(
    ...
    description="A helpful assistant for planning and increasing productivity activities.",
    memory_service=memory_service,
    session_service=session_service,
    instruction="""You are productivity agent. """,
    tools=[google_search],
)
...
class ProductivityAgentRunner():
    def __init__(self, agent: Agent):
        self.agent = agent
        self.runner = InMemoryRunner(agent=agent, app_name="ProductivityAgentApp")
