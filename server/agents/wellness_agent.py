...
wellness_agent = Agent(
    ...
    description="A helpful assistant for planning and tracking wellness activities.",
    memory_service=memory_service,
    session_service=session_service,
    instruction="""You are wellness agent. """,
    tools=[google_search],
)
...
class WellnessAgentRunner():
    def __init__(self, agent: Agent):
        self.agent = agent
        self.runner = InMemoryRunner(agent=agent, app_name="WellnessAgentApp")
