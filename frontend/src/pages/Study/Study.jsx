...
const Study = () => {
  ...
  const subjectMap = {};
  sessions.forEach((s) => {
    const shortSubj = generateShortTitle(s.subject);
    subjectMap[shortSubj] = (subjectMap[shortSubj] || 0) + (s.duration || 0);
  });
  ...
  return (
    ...
    >
        ...
        <div className="p-6 rounded-3xl glass-card bg-blue-500/5 border-blue-500/10 flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-4 flex-1">
            <div className="p-4 rounded-2xl bg-blue-500/10 border border-blue-500/10 flex flex-col items-center justify-center">
              <span className="text-3xl font-bold text-blue-400 font-display">
                {sessions.length}
              </span>
            ...
            <div className="p-4 rounded-2xl bg-purple-500/10 border border-purple-500/10 flex flex-col items-center justify-center">
              <span className="text-3xl font-bold text-purple-400 font-display">
                {totalHours}h
              </span>
      ...
      {/* Session Timeline */}
      <div className="rounded-3xl bg-black/20 backdrop-blur-sm border border-white/10 p-6 shadow-xl">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-white/20 text-sm mt-1">
                Use the Orchestrator chat or click "Log Session" to add one.
              </p>
            </div>
          ) : (
              ...
              >
                ...
                <div className="flex justify-between items-start">
                  <div
                    ...
                    onClick={() =>
                      setExpandedSession(
                        expandedSession === (session.id || idx)
                          ? null
                          : session.id || idx,
                      )
                    }
                  >
                    <h4 className="text-lg font-bold text-white tracking-tight leading-tight">
                      {generateShortTitle(session.subject)}
                    </h4>
                    <span className="text-sm text-blue-400 mt-1 block tracking-wide line-clamp-1">
                      {session.subject}
                    </span>
              ...
              <form onSubmit={handleAddSession} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={addForm.topic}
                    onChange={(e) =>
                      setAddForm((p) => ({ ...p, topic: e.target.value }))
                    }
                    className="w-full glass-input rounded-xl px-4 py-3"
